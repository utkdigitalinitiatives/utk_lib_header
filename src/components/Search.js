                        ...
                        <div className="utk-search-options">
                            <label id="utk-search-toggle-onesearch" onClick={this.setSearchOptionOnesearch}>
                                <svg id="utk-onesearch"
                                    ...
                                    <path d="M56.7.81H74V5.28H61.7V9.92H72.48V14.4H61.7v4.8H74.12v4.48H56.7Z"/>
                                    <path d="M76.86,20.35l1.63-1.93a11.13,11.13,0,0,0,8,3.3c3.14,0,5.21-1.66,5.21-4v-.06c0-2.17-1.17-3.41-6.08-4.44-5.37-1.17-7.84-2.91-7.84-6.74V6.44C77.79,2.77,81,.07,85.47.07a12.16,12.16,0,0,1,8.21,2.87L92.14,5A10.25,10.25,0,0,0,85.4,2.44c-3,0-5,1.66-5,3.77v.06c0,2.2,1.2,3.44,6.34,4.54s7.61,3,7.61,6.61v.07c0,4-3.34,6.6-8,6.6A13.63,13.63,0,0,1,76.86,20.35Z"/>
                                    <path d="M96,.4h16.88V2.8H98.58v8h12.75v2.4H98.58v8.18H113v2.4H96Z"/>
                                    <path d="M124.88.23h2.47L138,23.76h-2.84l-2.73-6.17H119.7l-2.76,6.17h-2.71Zm6.5,15L126.08,3.3l-5.34,11.88Z"/>
                                    <path d="M139.1.4h10a9.19,9.19,0,0,1,6.64,2.34,6.42,6.42,0,0,1,1.81,4.6v.07c0,3.87-2.67,6.14-6.35,6.8l7.18,9.55h-3.24l-6.77-9.08h-6.68v9.08H139.1Zm9.81,11.91c3.5,0,6-1.8,6-4.8V7.44c0-2.87-2.21-4.6-6-4.6h-7.21v9.47Z"/>
                            ...
                            <label id="utk-search-toggle-libraries"
                                ...
                                <span className="sr-only">Search our website for services and more</span>
                                <span>Website</span>
                            </label>
                        </div>
